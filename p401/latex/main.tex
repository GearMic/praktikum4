...
Die Plots mit Fit sind in Abb. \ref{fig:gauss-fit-1} und \ref{fig:gauss-fit-2} gezeigt, die Parameter in Tab. \ref{}
...
\begin{table}[h]
  ...
  \centering
  \csvreader[
    table head=\hline $I$ & $a_1$ & $\Delta a_1$ & $\mu_1$ & $\Delta \mu_1$ & $\sigma_1$ & $\Delta \sigma_1$
      $a_2$ & $\Delta a_2$ & $\mu_2$ & $\Delta \mu_2$ & $\sigma_2$ & $\Delta \sigma_2$
      $a_3$ & $\Delta a_3$ & $\mu_3$ & $\Delta \mu_3$ & $\sigma_3$ & $\Delta \sigma_3$ & $B$ & $\Delta B$\\,
