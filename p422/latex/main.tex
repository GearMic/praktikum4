...
\begin{figure}[h!]
    ...
    \caption{Schematische Darstellung des Tunneleffekts \cite{TunnelEffekt}}
...
\begin{figure}[h!]
    ...
    \label{fig:aufbau}
\end{figure}
Unser STM besitzt einen externen Controller, der vov dem Programm "easyScan 2" kontrolliert wird. DIe 
Es gibt 2 USb-Lupen.Es wird zur Aufnahme der Probe und verwendeten Spitzen benutzt. Der Gegenstand wird besser positioniert, 
indem man in den x-y-z Positioniertisch ein Magnet verbaut. Die andere nutzt man über dem STM, um den 
Anfahrvorgangs der Probe zur Spitze zu beobachten.
Zusätzlich bestizt man zum Versuch einen Box mit dem folgenden Inhalt: 

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.49\textwidth]{box-inhalt.png}
    \caption{Werkzeuge, Bauteile und Proben des Versuchs \cite{Anleitung}}
    \label{fig:box-inhalt}
\end{figure}
Hier befindet sich alles, was zum Versuch untersucht wird. Dazu gabt es einen Seitenschneiders, der zum Präparation
der Spitze angewendet wird. 
...
\bibitem{TunnelEffekt}
\textit{Tunnel Effect Diagram}, Wikimedia Commons, 29.11.2024, \url{https://commons.wikimedia.org/wiki/File:TunnelEffektKling1.svg}
